...
#define DESCRIPTION "Fast and Portable Cryptography Extension Library for Telegram\n" \
    "dzgram-tgcrypto is a cryptography extension library for Telegram MTProto\n" \
    "You can learn more about this project here: https://github.com/DownloaderZone/dzgram-tgcrypto\n"
